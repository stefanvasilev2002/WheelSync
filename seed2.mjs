// Continuation seed — runs after companies/users/vehicles already exist
// IDs: companies 1,2 | vehicles 1-6 | drivers 5-9
...
async function main() {
  ...
  await post('/vehicles/1/assign', { driverId: 5, assignedDate: '2026-01-01' }, fm1);
  await post('/vehicles/2/assign', { driverId: 6, assignedDate: '2026-01-01' }, fm1);
  await post('/vehicles/3/assign', { driverId: 7, assignedDate: '2026-01-01' }, fm1);
  await post('/vehicles/5/assign', { driverId: 8, assignedDate: '2026-01-01' }, fm2);
  await post('/vehicles/6/assign', { driverId: 9, assignedDate: '2026-01-01' }, fm2);
  console.log('  5 assignments done');
  ...
  console.log('Defects...');
  const def = [
    [1, 'Abenje na kocnici',                 'Se slusha shkripen.e pri kochen.e, prednite plochki treba zamena',             'HIGH',   dt1],
    ...
    [4, 'Grebnati.na na predniot branik',     'Lesna grebnati.na pri manevrirane vo skladi.shteto',                           'LOW',    adm],
    [5, 'Vibracie pri voz.en.e',              'Pri brzina nad 80km/h vibracii na volanot, nebalansirani trkala',              'MEDIUM', dt4],
    [5, 'Osteten.o stranichno ogledalo desno','Ogledalo osteten.o, potrebna zamena',                                          'LOW',    dt4],
    [6, 'Slaba baterija',                     'Teshko pal.en.e nautro, baterijata treba proverka i eventualna zamena',        'MEDIUM', dt5],
    [6, 'Greshka vo senzor za pritisok gumi', 'Indikatorot postojano sveti, verojtno neispraven TPMS senzor',                'LOW',    dt5],
  ];
